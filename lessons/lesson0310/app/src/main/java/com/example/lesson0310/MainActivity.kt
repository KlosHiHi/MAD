package com.example.lesson0310
...
import com.example.lesson0310.ui.theme.Lesson0310Theme
...
fun ColorAnimationExample(){
    ...
    val offsetX by animateDpAsState(
        targetValue = if(isBlue) 200.dp else 50.dp,
...
fun RotationAnimationExample(){
    ...
    val rotation by animateFloatAsState(
        ...
        animationSpec = tween ( 1000,
            easing = CubicBezierEasing(0.64f, 1.84f,0.99f,1.01f)
            )
    )
    Box (
        Modifier
...
fun InfiniteTransitionExample(){
    ...
    val scale by transition.animateFloat(
        initialValue = 4f, targetValue = 10f,
